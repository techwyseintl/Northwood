...
try:
    ...
    pid = open('/home/nwm/webapps/rails/log/mongrel.pid').read()
...
if running:
    ...
    os.system('/usr/local/bin/mongrel_rails start -d -e production -P /home/nwm/webapps/rails/log/mongrel.pid -p 2618')